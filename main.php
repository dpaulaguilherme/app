		...
		<div class="row">
			<div class="medium-1 columns">
				<div class="main-purple-button">
					<a href="http://cormaya.com/guilherme/tela_login.php" target="_self" id="enter">
						ACESSAR
					</a><br>
				</div>
			</div>
		...
		<div class="row">
			<div class="medium-1 columns">
				<div class="main-white-button">
					<a href="http://cormaya.com/guilherme/criar_conta.php" target="_self" class="main-button" id="createAccount">
						CRIAR MINHA CONTA
					</a>
				</div>
			</div>
